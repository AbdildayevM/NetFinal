...
namespace NetFinal.Controllers
{
    public class UsersController : Controller
    {
        ...
        public UsersController(NetFinalContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,LastName,FirstName,PhoneNumber,Password,SignDate")] User user)
        {
            if (id != user.ID)
            {
                return NotFound();
